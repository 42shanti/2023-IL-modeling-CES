...
# READ EXPERIMENTAL DATA
    # full_file_path_rho = ["C:/Users/bc_usp/My Drive (cleitonberaldo@usp.br)/usp brainstorm/brainstorm 03/csv-aad-rho/mix_rho.csv"]
    # full_file_path_T = ["C:/Users/bc_usp/My Drive (cleitonberaldo@usp.br)/usp brainstorm/brainstorm 03/csv-aad-rho/mix_T.csv"]
...
# PLOT MODEL
    ...
    PyPlot.plot(model_rho[2],T[2],label="",linestyle="-",color="forestgreen")
    PyPlot.plot(model_rho[3],T[3],label="",linestyle="-",color="hotpink")
    PyPlot.plot(model_rho[4],T[4],label="",linestyle="-",color="royalblue")
    ...
    PyPlot.plot(model_rho[9],T[9],label="",linestyle="--",color="forestgreen")
    PyPlot.plot(model_rho[10],T[10],label="",linestyle="--",color="hotpink")
    PyPlot.plot(model_rho[11],T[11],label="",linestyle="--",color="royalblue")
...
# PLOT EXPERIMENTAL
    PyPlot.plot(exp_rho[1],exp_T[1],label="[C₂MIM][BF₄]",linestyle="",marker="o",color="black")
    PyPlot.plot(exp_rho[2],exp_T[2],label="[C₄MIM][BF₄]",linestyle="",marker="v",color="forestgreen")
    PyPlot.plot(exp_rho[3],exp_T[3],label="[C₆MIM][BF₄]",linestyle="",marker="^",color="hotpink")
    PyPlot.plot(exp_rho[4],exp_T[4],label="[C₈MIM][BF₄]",linestyle="",marker="<",color="royalblue")
    PyPlot.plot(exp_rho[5],exp_T[5],label="[C₄MIM][PF₆]",linestyle="",marker=">",color="orange")
    PyPlot.plot(exp_rho[6],exp_T[6],label="[C₆MIM][PF₆]",linestyle="",marker="1",color="indigo")
    ...
    # PyPlot.plot(exp_rho[9],exp_T[9],label="9",linestyle="",marker="4",color="sienna")
    # PyPlot.plot(exp_rho[10],exp_T[10],label="10",linestyle="",marker="s",color="olive")
    # PyPlot.plot(exp_rho[11],exp_T[11],label="11",linestyle="",marker="2",color="dimgray")
# PLOT AXES
